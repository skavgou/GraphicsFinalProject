	...
	void initialize(glm::vec3 position, glm::vec3 scale, int texID) {
        ...
        switch(texID) {
            case 1:
                ...
                break;
            case 2:
                textureID = LoadTextureTileBox("../lab2/facade3.jpg");
                break;
            case 3:
                textureID = LoadTextureTileBox("../lab2/facade2.jpg");
                break;
            case 4:
                textureID = LoadTextureTileBox("../lab2/facade1.jpg");
                break;
            case 5:
                textureID = LoadTextureTileBox("../lab2/facade0.jpg");
                break;
            case 6:
                textureID = LoadTextureTileBox("../lab2/facade5.jpg");
                break;
            default:
                textureID = LoadTextureTileBox("../lab2/facade5.jpg");
                break;
